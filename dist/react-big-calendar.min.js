!(function(e, t) {
  ...
  function mt(e) {
    return (function(e) {
      return e.replace(pt, '-$1').toLowerCase()
    })(e).replace(ht, '-ms-')
  }
  ...
  function gt(e, t) {
    var n = '',
      r = ''
    if ('string' == typeof t)
      return e.style.getPropertyValue(mt(t)) || dt(e).getPropertyValue(mt(t))
  ...
  function Xt(e) {
    ...
    var t = Bt(e),
      ...
      r = t.overflowX,
      o = t.overflowY
    return /(auto|scroll|overlay)/.test(n + o + r) ? e : Xt($t(e))
  }
  function Gt(e) {
    return e && e.referenceNode ? e.referenceNode : e
  }
  var qt = Ht && !(!window.MSInputMethodContext || !document.documentMode),
    Kt = Ht && /MSIE 10/.test(navigator.userAgent)
  function Zt(e) {
  ...
  function vn(e, t, n) {
    ...
    return dn(n, r ? pn(t) : en(t, Gt(n)), r)
  }
  function gn(e) {
  ...
  function Mn(e, t, n, r) {
    ;(n.updateBound = r),
      Sn(e).addEventListener('resize', n.updateBound, { passive: !0 })
    var o = Xt(e)
    return (
      (function e(t, n, r, o) {
  ...
  function Dn() {
    ...
    this.state.eventsEnabled &&
      ...
      (t = this.state),
      Sn(e).removeEventListener('resize', t.updateBound),
  ...
  var jn = Ht && /Firefox/i.test(navigator.userAgent)
  function Nn(e, t, n) {
    var r = wn(e, function(e) {
        return e.name === t
      }),
        ...
        arrow: {
          ...
          fn: function(e, t) {
            ...
            return (
              ...
              (e.arrowElement = r),
              (e.offsets.arrow = (cn((n = {}), f, Math.round(b)),
              cn(n, d, ''),
              n)),
              e
            )
        ...
        applyStyle: {
          ...
          fn: function(e) {
            ...
            return (
              ...
              e.arrowElement &&
                ...
                Tn(e.arrowElement, e.arrowStyles),
              e
            )
          },
          onLoad: function(e, t, n, r, o) {
            ...
            return (
              ...
              Tn(t, { position: n.positionFixed ? 'fixed' : 'absolute' }),
              n
            )
          },
  ...
  ;(Ln.Utils = ('undefined' != typeof window ? window : global).PopperUtils),
    (Ln.placements = Cn),
    (Ln.Defaults = Pn)
  var zn = function(e) {
  ...
  var Qn = r.forwardRef(function(e, n) {
    var i = e.flip,
      a = e.placement,
      ...
      M = (function(e, n, r) {
        ...
        return (
          ...
          t.useEffect(
            function() {
              if (a && null != e && null != n) {
                var t = h.arrow && Wt({}, h.arrow, { element: h.arrow.element })
                return (
                  (m.current = new Ln(e, n, {
                    placement: c,
                    positionFixed: u,
                    modifiers: Wt({}, h, {
                      arrow: t,
        ...
        Wt({}, l, {
          ...
          enableEvents: e.show,
          modifiers: Wt({}, S, {
            preventOverflow: Wt({ padding: s || 5 }, S.preventOverflow),
            arrow: Wt({}, S.arrow, { enabled: !!m, element: m }),
            flip: Wt({ enabled: !!i }, S.preventOverflow),
          }),
        })
      ),
      D = M.styles,
    ...
    if (
      ...
      t.useEffect(
        function() {
          if (!k && null != j) {
            var e = $n(document, F, I, !0),
              t = $n(document, F, z),
              n = $n(document, 'keyup', W),
              r = []
            return (
              'ontouchstart' in document.documentElement &&
                (r = [].slice.call(document.body.children).map(function(e) {
                  return $n(e, 'mousemove', Kn)
                })),
              function() {
                e(),
                  t(),
  ...
  ;(Qn.displayName = 'Overlay'),
    (Qn.propTypes = {
      show: b.bool,
      placement: b.oneOf(Ln.placements),
      target: b.any,
      container: b.any,
      flip: b.bool,
    ...
    (Qn.defaultProps = { containerPadding: 5 })
  var tr,
    nr = Function.prototype.bind.call(Function.prototype.call, [].slice)
  function rr(e, t) {
    if (!tr) {
      var n = document.body,
        r =
  ...
  var cr = (function() {
    function e(e, t) {
      ...
      ;(this.isDetached = !1),
        ...
        (this._removeTouchMoveWindowListener = or(
          'touchmove',
          function() {},
          window
        )),
        (this._removeKeyDownListener = or('keydown', this._keyListener)),
        (this._removeKeyUpListener = or('keyup', this._keyListener)),
        (this._removeDropFromOutsideListener = or(
          'drop',
          this._dropFromOutsideListener
        )),
        (this._onDragOverfromOutisde = or(
          'dragover',
    ...
    return (
      ...
      (t.isSelected = function(e) {
        ...
        return !(!t || !this.selecting) && lr(t, ur(e))
      }),
      (t.filter = function(e) {
        ...
        var n = this,
          ...
          a = function(t) {
            ;(r = setTimeout(function() {
              ...
              (o = or('touchmove', function() {
                return c()
              })),
              (i = or('touchend', function() {
                return c()
              }))
          },
          s = or('touchstart', a),
      ...
      (t._addInitialEventListener = function() {
        var e = this,
          t = or('mousedown', function(t) {
            e._removeInitialEventListener(),
              e._handleInitialEvent(t),
              (e._removeInitialEventListener = or(
                'mousedown',
                e._handleInitialEvent
              ))
          }),
          n = or('touchstart', function(t) {
            e._removeInitialEventListener(),
        ...
        if (!this.isDetached) {
          ...
          if (
            ...
            if (
              ...
              switch (e.type) {
                case 'mousedown':
                  ;(this._removeEndListener = or(
                    'mouseup',
                    this._handleTerminatingEvent
                  )),
                    (this._onEscListener = or(
                      'keydown',
                      this._handleTerminatingEvent
                    )),
                    (this._removeMoveListener = or(
                      'mousemove',
  ...
  ;(vr.propTypes = {}), (vr.defaultProps = a({}, pr))
  ...
  var wr,
    ...
    _r = (wr = /[^.]+$/.exec((Er && Er.keys && Er.keys.IE_PROTO) || ''))
      ? 'Symbol(src)_1.' + wr
      : ''
  ...
  function Cr(e) {
    return (
      !(!Le(e) || ((t = e), _r && _r in t)) && (Ue(e) ? Nr : Mr).test(Sr(e))
    )
    var t
  }
  function Rr(e, t) {
  ...
  var Qr = 1,
    ...
    co = '[object String]',
    lo = '[object Symbol]',
    uo = '[object ArrayBuffer]',
    fo = '[object DataView]',
    po = xe ? xe.prototype : void 0,
    ho = po ? po.valueOf : void 0
  function mo(e, t) {
  ...
  var So = Object.prototype,
    ...
    xo = Oo(
      ...
      ? Oo
      : function(e) {
          return Ke(e) && Mo.call(e, 'callee') && !Do.call(e, 'callee')
        }
  var To = 'object' == typeof e && e && !e.nodeType && e,
    jo =
      To && 'object' == typeof module && module && !module.nodeType && module,
    No = jo && jo.exports === To ? De.Buffer : void 0,
    Co =
      (No ? No.isBuffer : void 0) ||
      function() {
        return !1
      },
    Ro = {}
  ...
  var Ao = 'object' == typeof e && e && !e.nodeType && e,
    ...
    Po = Fo && Fo.exports === Ao && Se.process,
    Lo = (function() {
      try {
    ...
    Io = Lo && Lo.isTypedArray,
    zo = Io
      ? ko(Io)
      : function(e) {
          return Ke(e) && Ye(e.length) && !!Ro[Pe(e)]
        },
  ...
  function Vo(e) {
    ...
    return e === (('function' == typeof t && t.prototype) || Uo)
  }
  function Yo(e, t) {
    return function(n) {
      return e(t(n))
  ...
  var Zo = Rr(De, 'DataView'),
    ...
    ii = Sr(ei),
    ai = Pe
  ;((Zo && '[object DataView]' != ai(new Zo(new ArrayBuffer(1)))) ||
    (kr && '[object Map]' != ai(new kr())) ||
    (Jo && '[object Promise]' != ai(Jo.resolve())) ||
    (Qo && '[object Set]' != ai(new Qo())) ||
    (ei && '[object WeakMap]' != ai(new ei()))) &&
    (ai = function(e) {
      var t = Pe(e),
        ...
        a || zo(e)
          ...
          : (function(e, t, n, r, o, i, a) {
              switch (n) {
                ...
                case uo:
                  return !(
                    e.byteLength != t.byteLength || !i(new Kr(e), new Kr(t))
                  )
                case to:
                case no:
                case io:
            ...
            (function(e, t, n, r) {
              ...
              for (; ++o < i; ) {
                ...
                if (a && s[2]) {
                  ...
                  if (!(void 0 === d ? hi(u, l, mi | vi, r, f) : d)) return !1
                }
              }
              return !0
            })(n, e, t)
  ...
  function _i(e, t) {
    ...
    return (
      ...
      (Ei.test(e) || !wi.test(e) || (null != t && e in Object(t)))
    )
  }
  ...
  function Si(e, t) {
    ...
    return (n.cache = new (Si.Cache || Hr)()), n
  }
  Si.Cache = Hr
  var Mi = 500
  var Di,
  ...
  var ki = 1 / 0,
    Ai = xe ? xe.prototype : void 0,
    Fi = Ai ? Ai.toString : void 0
  function Pi(e) {
    if ('string' == typeof e) return e
    if (vo(e)) return Ri(e, Pi) + ''
    if (Je(e)) return Fi ? Fi.call(e) : ''
    var t = e + ''
    ...
    return _i(e) && gi(t)
      ...
      : function(n) {
          var r = (function(e, t, n) {
            var r = null == e ? void 0 : Wi(e, t)
            return void 0 === r ? n : r
          })(n, e)
          return void 0 === r && r === t ? Ui(n, e) : hi(t, r, Vi | Yi)
        }
  }
  function $i(e) {
    return e
  ...
  var oa,
    ia = function(e, t, n) {
      return (
        ...
        (function(e, t, n, r) {
          for (
            var o = -1, i = ra(na((t - e) / (n || 1)), 0), a = Array(i);
            i--;

          )
            (a[r ? i : ++o] = e), (e += n)
          return a
        })(e, t, (n = void 0 === n ? (e < t ? 1 : -1) : st(n)), oa)
      )
    },
    aa = function(e, t) {
    ...
    ca = (function(e) {
      ...
      return (
        ...
        (n.canRenderSlotEvent = function(e, t) {
          ...
          return ia(e, e + t).every(function(e) {
            return 1 === sa(n, e)
          })
        }),
  ...
  ;(ca.propTypes = {}), (ca.defaultProps = a({}, pr))
  var la = function(e, t) {
    return e === t
  }
  function ua(e, t) {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              a({ isAllDay: _ }, x),
              S.map(function(e, t) {
                return r.createElement(vr, a({ key: t, segments: e }, x))
              }),
              !!M.length &&
                r.createElement(
                  ca,
        ...
        return (
          ...
          (t.renderWeek = function(e, n) {
            var o = t.props,
              ...
              g = m.rowLimit
            return (
              (i = va(i, e[0], e[e.length - 1], p)).sort(function(e, t) {
                return ta(e, t, p)
              }),
              r.createElement(pa, {
                key: n,
                ...
                range: e,
                events: i,
                maxRows: t.props.rowLimit ? t.props.rowLimit : g,
                selected: l,
                selectable: s,
                components: a,
                accessors: p,
  ...
  var _a = xe ? xe.isConcatSpreadable : void 0
  function Oa(e) {
    return vo(e) || xo(e) || !!(_a && e && e[_a])
  }
  ...
  function Ca(e, t, n) {
    return (
      (t = Na(void 0 === t ? e.length - 1 : t, 0)),
      function() {
        for (
          var r = arguments, o = -1, i = Na(r.length - t, 0), a = Array(i);
          ++o < i;
  ...
  var La = (function(e) {
    ...
    return function() {
      var r = Pa(),
        o = Fa - (r - n)
      if (((n = r), o > 0)) {
        if (++t >= Aa) return arguments[0]
      } else t = 0
      return e.apply(void 0, arguments)
    }
  })(ka)
  function Ia(e, t) {
    return La(Ca(e, t, $i), e + '')
  }
  var za = Ia(function(e, t) {
      if (null == e) return []
      var n = t.length
      return (
        n > 1 && qe(e, t[0], t[1])
    ...
    for (
      var t = e.events,
        ...
        i = (function(e) {
          ...
          t.map(function(e) {
            return new Wa(e, { slotMetrics: r, accessors: o })
          })
        ),
        a = [],
        s = function(e) {
      ...
      return (
        ...
        (t._selectable = function() {
          var e = n.findDOMNode(F(t)),
            ...
            i = function(n) {
              var r = t.slotMetrics.closestSlotFromPoint(n, ur(e))
  ...
  ;(Ga.propTypes = {}),
    (Ga.defaultProps = { dragThroughEvents: !0, timeslots: 2 })
  var qa,
    Ka = (function(e) {
      function t() {
        ...
        var a = t.props,
          ...
          u = a.step
        return (
          (t.slotMetrics = wa({ min: s, max: c, timeslots: l, step: u })), t
        )
      }
      c(t, e)
      var n = t.prototype
    ...
    return (
      ...
      (n.render = function() {
        var e = this,
          ...
          b = void 0 === y ? Qa : y,
          w = {}
        m && (w[o ? 'marginLeft' : 'marginRight'] = Ja() + 'px')
    ...
    function t(t) {
      ...
      return (
        ...
        (o.handleResize = function() {
          Rt(o.rafHandle), (o.rafHandle = kt(o.checkOverflow))
        }),
        ...
        (o.memoizedResources = ua(function(e, t) {
          return (function(e, t) {
            return {
              map: function(n) {
                return e
  ...
  function is(e, t) {
    return os.range(e, t).filter(function(e) {
      return -1 === [6, 0].indexOf(e.getDay())
    })
  }
  ;(os.propTypes = {}),
    (os.defaultProps = ns.defaultProps),
  ...
  ;(as.propTypes = {}),
    (as.defaultProps = ns.defaultProps),
    (as.range = is),
    (as.navigate = os.navigate),
            ...
            if (n.tbodyRef.current) {
              ...
              if (t) {
                var r,
                  ...
                  a = n._widths || []
                ;(n._widths = [Za(t.children[0]), Za(t.children[1])]),
                  ...
                  i
                    ? ((o = 'rbc-header-overflowing'),
                      ...
                      (e.style.marginRight = Ja() + 'px'))
                    : (function(e, t) {
                        e.classList
                          ? e.classList.remove(t)
                          : 'string' == typeof e.className
                          ? (e.className = ss(e.className, t))
                          : e.setAttribute(
                              'class',
                              ss((e.className && e.className.baseVal) || '', t)
                            )
  ...
  ;(ls.propTypes = {}),
    ...
    (ls.range = function(e, t) {
      ...
      return {
        start: e,
        end: $(e, void 0 === n ? ls.defaultProps.length : n, 'day'),
      }
    }),
  ...
  function vs(e, t, n) {
    var r = e[t]
    ;(ms.call(e, t) && Oe(r, n) && (void 0 !== n || t in e)) || hs(e, t, n)
  }
  function gs(e, t, n, r) {
    var o = !n
    n || (n = {})
  ...
  function ws(e) {
    return Be(e) ? Ho(e, !0) : bs(e)
  }
  var Es = 'object' == typeof e && e && !e.nodeType && e,
    _s =
      Es && 'object' == typeof module && module && !module.nodeType && module,
    Os = _s && _s.exports === Es ? De.Buffer : void 0,
    Ss = Os ? Os.allocUnsafe : void 0
  var Ms = Yo(Object.getPrototypeOf, Object),
    Ds = Object.getOwnPropertySymbols
      ? function(e) {
          for (var t = []; e; ) mo(t, Eo(e)), (e = Ms(e))
          return t
        }
      : yo
  function xs(e) {
  ...
  var Ns = /\w*$/
  var Cs = xe ? xe.prototype : void 0,
    Rs = Cs ? Cs.valueOf : void 0
  ...
  function Js(e, t, n) {
    ...
    switch (t) {
      ...
      case Ls:
        return (
          ((i = new (o = e).constructor(o.source, Ns.exec(o))).lastIndex =
            o.lastIndex),
          i
        )
      case Is:
  ...
  function mc(e, t, n, r, o, i) {
    ...
    var h = l ? (c ? xs : Go) : c ? keysIn : Xo,
      m = u ? void 0 : h(e)
    return (
      ps(m || e, function(r, o) {
        m && (r = e[(o = r)]), vs(a, o, mc(r, t, n, o, e, i))
      }),
      a
    )
  }
  function vc(e, t) {
    return (
      null ==
        (e = (function(e, t) {
          return t.length < 2 ? e : Wi(e, _e(t, 0, -1))
        })(e, (t = Li(t, e)))) ||
      delete e[
  ...
  ;(hc[uc] = hc['[object Array]'] = hc['[object ArrayBuffer]'] = hc[
    '[object DataView]'
  ...
  function Oc(e) {
    return (function(e) {
      if (!Ke(e) || Pe(e) != gc) return !1
      var t = Ms(e)
      if (null === t) return !0
      var n = Ec.call(t, 'constructor') && t.constructor
      return 'function' == typeof n && n instanceof n && wc.call(n) == _c
    })(e)
      ? void 0
      : e
  }
  ...
  var Mc = (function(e) {
    ...
    Tc = Ia(function(e, t) {
      ...
      for (o && qe(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var i = t[n], a = ws(i), s = -1, c = a.length; ++s < c; ) {
          var l = a[s],
            u = e[l]
          ;(void 0 === u || (Oe(u, Dc[l]) && !xc.call(e, l))) && (e[l] = i[l])
        }
      return e
    })
  var jc = function(e) {
      ...
      return (
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = Gi(t)), null == n)) {
                  ...
                  n = o ? (r ? new i() : []) : Le(e) && Ue(i) ? ec(Ms(e)) : {}
                }
                return (
                  (o ? ps : Da)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
        ...
        (t.handleNavigate = function(e, n) {
          var r = t.props,
            ...
            d = c()
          l(
            (i = fs(f, a({}, u, { action: e, date: n || i || d, today: d }))),
            o,
            e
          ),
  ...
  var Rc = (function e(t, n, o) {
    ...
    })(Cc, { view: 'onView', date: 'onNavigate', selected: 'onSelectEvent' }),
    kc = function(e, t, n) {
      var r = e.start,
        o = e.end
  ...
  var Wc = function(e, t, n) {
    ...
    Uc = { eventWrapper: i, timeSlotWrapper: i, dateCellWrapper: i }
  ;(e.Calendar = Rc),
    (e.DateLocalizer = R),
    (e.Navigate = x),
    (e.Views = T),
